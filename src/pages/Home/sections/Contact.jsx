        ...
        <div className={`footer-grid ${country === 'in' ? 'has-location' : ''}`}>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links-list">
              <li>
                <button onClick={() => handleLinkClick('about-section')} className="footer-text-link">
                  ABOUT US
                </button>
              </li>
              <li>
                <button onClick={() => handleLinkClick('services-section')} className="footer-text-link">
                  SERVICES
                </button>
              </li>
              <li>
                <button onClick={() => handleLinkClick('contact-section')} className="footer-text-link">
                  CONTACT
                </button>
              </li>
              <li>
          ...
          <div className="footer-col">
            ...
            <div className="footer-email-row" style={{ marginTop: '18px' }}>
            </div>
          </div>
