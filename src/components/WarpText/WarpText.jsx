...
const WarpText = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      gl = renderer.gl;
    } catch (e) { console.warn('WarpText: WebGL init failed', e); return; }
    ...
    const onReducedMotion = e => { reduceMotion = e.matches; program.uniforms.uMotion.value = reduceMotion ? 0 : 1; renderOnce(); };
  ...
  return (
    <div
      ref={containerRef}
      className={`warp-text-root ${className}`.trim()}
