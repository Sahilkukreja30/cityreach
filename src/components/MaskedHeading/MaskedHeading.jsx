...
const MaskedHeading = ({
  ...
  return (
    <Tag
      ref={rootRef}
      className={`masked-heading-root ${className}`.trim()}
      style={{
        textAlign: align,
        fontWeight: weight,
    ...
    >
        ...
        {words.map((word, i) => (
          ...
          >
            ...
            <i
              ...
              className="masked-heading-base"
            />
          </span>
        ))}
      </span>

      <svg className="masked-heading-svg" aria-hidden="true" focusable="false">
        <defs>
      ...
      <span ref={revealRef} className="masked-heading-reveal">
        <span className="masked-heading-clip-wrap" style={{ clipPath: `url(#${clipId})` }}>
          <span ref={mediaRef} className="masked-heading-media-container">
            {mediaType === 'video' ? (
              <video
              ...
              <img className="masked-heading-media" src={src} alt="" draggable={false} />
            )}
          </span>
        </span>
      </span>
