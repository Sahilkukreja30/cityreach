...
const DriftWall = ({
    ...
    const inner = (
      <span className="drift-inner">
        <img
          ...
          className="drift-img"
        />
        <span className="drift-overlay" aria-hidden="true" />
      </span>
    );
    const commonProps = {
      className: cx('drift-tile', activeId === id && 'is-active'),
      'data-tile-id': id,
      'data-col': colIndex,
  ...
  return (
    <div
      ref={containerRef}
      className={cx('drift-wall-container', className)}
      style={cssVars}
