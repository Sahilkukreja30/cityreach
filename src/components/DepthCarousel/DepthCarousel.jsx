...
const DepthCarousel = ({
  ...
  return (
    <div
      ref={rootRef}
      className={`depth-carousel-container ${className}`.trim()}
    ...
    >
      ...
      {showControls && count > 1 && (
        <>
          <button
            type="button"
            className="depth-carousel-btn btn-prev"
          ...
          <button
            type="button"
            className="depth-carousel-btn btn-next"
        ...
        >
          {data.map((_, i) => (
            <button
              ...
              className={`depth-carousel-dot ${active === i ? 'is-active' : 'is-inactive'}`}
